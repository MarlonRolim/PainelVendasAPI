...
def hecto():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\01.11.csv', encoding='latin-1', sep=";")
    db = db[
...
def dbDiaB():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\03.01.36.04.csv', encoding='latin-1', sep=";")
    db = db[
...
def listaVDE():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\01.02.46.csv', encoding='latin-1', sep=";")
    db = db[
...
def PDVs():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\01.20.12-total.csv', encoding='latin-1', sep=";")
    db = db[
...
def grupoProd():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\grupoProdResumo.csv', encoding='latin-1', sep=";")
    db = db.fillna(0)
...
def diasUteis():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\DiasUteis.csv', encoding='latin-1', sep=";", header=None)

    db = [int(db[1][0]),int(db[1][1])]
    return db

def metas():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\05.10.csv', encoding='latin-1', sep=";", dtype='str')
...
metas()
def volumeMes():
    db = pd.read_csv(r'\\192.168.0.252\dados\TI\Robo\DadosIp\03.02.37.csv', encoding='latin-1', sep=";", dtype='str')
